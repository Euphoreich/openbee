...
local files = {
  {
    ...
    url = "https://raw.github.com/ankenyr/openbee/"..branch.."/openbee-install.lua"
  },
  {
    name = "openbee",
    url = "https://raw.github.com/ankenyr/openbee/"..branch.."/openbee.lua"
  },
  {
    name = "matron",
    url = "https://raw.github.com/ankenyr/openbee/"..branch.."/matron.lua"
  }
}
